...
<LINK href="bindex.jsp" type=image/ico rel=icon></LINK>
<LINK href="bindex.jsp" rel="shortcut icon"></LINK>
</HEAD>
<BODY>
<div style="z-index: 1">
<DIV class=header>
...
<DIV class=logo><A href="bindex.jsp"><IMG height=45 alt=''
src="image/logo.jpg" width=140></A></DIV>
</DIV>
...
<A title="{$limit_jg2_1}>-1元" href="begRent.do?method=selectBeanByPage&minprice=0.5&maxprice=1&showPage=1">30-80元</A> 
<A title="{$limit_jg2_2}>-5元" href="begRent.do?method=selectBeanByPage&minprice=1&maxprice=5&showPage=1">80-130元</A> 
<A title=130-180元 href="begRent.do?method=selectBeanByPage&minprice=5&maxprice=10&showPage=1">130-180元</A> 
<A title=180-230元 href="begRent.do?method=selectBeanByPage&minprice=10&maxprice=50&showPage=1">180-230元</A> 
<A title=230-280元 href="begRent.do?method=selectBeanByPage&minprice=50&maxprice=100&showPage=1">230-280元</A> 
<A title=280-330元 href="begRent.do?method=selectBeanByPage&minprice=100&maxprice=500&showPage=1">280-330元</A> 
<A title=330以上 href="begRent.do?method=selectBeanByPage&maxprice=500&showPage=1">330元以上</A> 
</DIV></DIV>
...
<UL>
  <LI class=tab_current><SPAN>找实习信息</SPAN></LI>
</UL>
...
<DIV id=hz_price class=rent_info_ds>${br.minprice } - ${br.maxprice }元/天
</DIV>
<DIV class=rent_info_dd >${br.colore }结账方式/每周可工作 ${br.sort }天/ ${br.kind }实习经验  ${br.time }</DIV></DIV>
...
alt=免费发布找实习信息 src="images/rent_btn.gif"></A> </DIV>
<SCRIPT>
...
href="http://www.miibeian.gov.cn/">鲁ICP备13028537号</A></SPAN></DIV></DIV>
