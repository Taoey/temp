...
<H1 title=eeju><A href="bindex.jsp"><IMG alt=eeju 
src="image/logo.jpg" width="180" height="50"></A></H1></DIV>
...
style="MARGIN-TOP: 3px" href="bindex.jsp">返回首页</A>
<script type="text/javascript">
   function logout(){
     if(confirm("你确定要退出吗？")){
       window.location="business.do?method=logout&fromto=user";
     }
   }
</script>
</DIV>
...
<DL>
  ...
  <DD><A class=active href="businessInfo1.jsp"><SPAN 
...
<UL class=tab>
  <LI class=normal><A 
  href="businessInfo1.jsp">用户详细信息</A> </LI>
  <LI class=active>修改密码 </LI>
  </UL>
<DIV class=wrap>
<DIV class=public>
<form action="business.do?method=updatePwd" method="post" onsubmit="return checkpwd();">
...
<TABLE>
  ...
  <TR>
    <TH></TH>
    <TD align="left">
    <input type="hidden" name="upwd1" id="upwd1" value="${business.bpwd}">
...
href="http://www.miibeian.gov.cn/">湘ICP备12345678号</A></SPAN></DIV></DIV></BODY></HTML>
