shuiguo<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
...
function delShuiguo(id)
{
	var del=document.getElementById("del");
	if(confirm("是否要删除.!"))
	{
		window.location="shuiguoType.do?method=deleteShuiguo_type&id="+id;
	}
}
</script>
</head>
...
<tr>
 <td height="26" background="skin/images/newlinebg3.gif">
  ...
  <tr>
  <td align="right">
    <input type='button' class="coolbg np" onClick="location='AddshuiguoType.jsp';" value='添加学历' />
  </td>
 </tr>
</table>
</td>
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="10" background="skin/images/tbg.gif">&nbsp;学历信息&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td> <a href="#" onclick="delShuiguo(${htype.id });" id="del">删除</a></td>
