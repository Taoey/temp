		...
		<DIV class=content>
			...
			<DIV id="left" align="left"
				...
				<DL>
					...
					<DD>
						<A class=normal href="user.jsp"><SPAN class=ico16>个人信息</SPAN>
						</A>
					</DD>
					<DD>
						<A class=active href="userInfo.jsp"><SPAN class=ico2>个人资料</SPAN>
						</A>
					</DD>
				</DL>
				<DL>
					...
					<DD>
						<A class=normal href="chooseshuiguo.jsp"><SPAN class=ico23>求购单</SPAN>
						</A>
					</DD>
				</DL>
				<DL>
					...
					<DD>
						<A class=normal href="usercz.jsp"><SPAN class=pub>发布销售信息</SPAN>
						</A>
					</DD>
					<DD>
						<A class=normal href="userqz.jsp"><SPAN class=pub>发布求购信息</SPAN>
						</A>
					</DD>
				</DL>
				<DL>
					...
					<DD>
						<A class=normal href="shuiguo.jsp"><SPAN class=ico1>个人水果信息管理</SPAN>
						</A>
						<br>
						<br>
					</DD>
			...
			<DIV id=right5>
				...
				<DIV class=wrap>
					<DIV class=public>
						<html:form action="usersInfo?method=AddUsersinfo" method="post"
