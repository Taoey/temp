...
<UL class=tab>
  <LI class=normal><A 
  href="shuiguo.jsp">实习招聘信息</A> </LI>
  <LI class="active">找实习信息</LI>
  </UL>
...
<TABLE id=my_goods>
  ...
  <TR class=line_bold>
    ...
    <TH colSpan=5></TH></TR>
  <tr><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td></tr><TR class=gray ectype="table_header">
    <TH width=28 height=33></TH>
    <TH width=40 align="left">序号</TH>
    <TH  inputwidth="90%" align="left">实习地址</TH>
    <TH class=cursor_pointer title=排序 width=72 column="cate_id"><SPAN 
      ectype="order_by">要求</SPAN></TH>
    <TH class=cursor_pointer title=排序 width=86 inputwidth="55px" 
    checker="check_required" column="brand" coltype="editable"><SPAN 
      ectype="order_by">招聘人数</SPAN></TH>
  ...
  <TR class="line last_line" ectype="table_item" name="tr_1653141"
    ...
    <TD  align="left"><SPAN class=color2>${br.colore }/ 可工作${br.sort }天/周$/{br.kind }年工作经验</SPAN></TD>
    <TD align="left" class=align2><SPAN class=color2 ectype="editobj">
	<FONT color=blue>${br.minarceage }~${br.maxarceage } 人</FONT></SPAN></TD>
