	  ...
	  <dl class='bitem'>
        ...
        <dd style='display:block' class='sitem' id='items1_1'>
          <ul class='sitemu'>
            ...
            <li><div class='fllct'><a href='shuiguoType.do?method=selectShuiguo_type' target='main'>实习学历管理</a></div> </li>
	  ...
	  <dl class='bitem'>
        ...
        <dd style='display:block' class='sitem' id='items1_1'>
          <ul class='sitemu'>
            <li>
              <div class='items'>
                <div class='fllct'><a href='leaseShuiguo.do?method=showShuiguoAdmin&showPage=1' target='main'>查看/编辑信息</a></div>
              </div>
            </li>
          </ul>
        </dd>
