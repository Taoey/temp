...
<html>
  <head>
     <title>My JSP 'AddshuiguoType.jsp' starting page</title>
     <script type="text/javascript">
	function checkshuiguo()
	{
		var checkshuiguo=document.getElementById("type").value;
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
						<tr>
							...
							<td width="85%" style="width: 626px">
								<div class='icoitem'>
									<html:form action="shuiguoType?method=addShuiguo" method="post" onsubmit="return checkshuiguo();">
										<table>
											<tr>
												<td align="right">
													学历名称：
