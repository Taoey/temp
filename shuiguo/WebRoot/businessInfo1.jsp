				...
				<DIV class=header_BottomC1>
					<DIV class=nav_second>
						<UL>
							...
							<LI class=nav_second1 style="WIDTH: 130px">
								<A onClick="window.location='qzindex.jsp';" href="javascript:">找实习</A>
							</LI>
							<LI class=nav_second1 style="WIDTH: 130px">
		...
		<DIV class=content>
			...
			<DIV id="left" align="left"
				...
				<DL>
					...
					<DD>
						<A class=normal href="business.jsp"><SPAN class=ico16>个人信息</SPAN>
						</A>
					</DD>
					<DD>
						<A class=active href="businessInfo1.jsp"><SPAN class=ico2>个人资料</SPAN>
						</A>
					</DD>
				</DL>
			...
			<DIV id=right5>
				<UL class=tab>
					...
					<LI class=normal>
						<A href=update_bpwd.jsp>修改密码</A>
					</LI>
				</UL>
				<DIV class=wrap>
					<DIV class=public>
						<html:form action="business?method=AddBusinessinfo" method="post"
									...
									<TABLE>
										<TBODY>
											<TR>
												...
												<TD align="left">
													${business.uname}
													<input type="hidden" value="${business.uname}" name="uname">
											</TR>
											<TR>
												<TH>
													电子邮箱：
												...
												<TD align="left">
													<INPUT name=bemail id="bemail" value="${business.bemail}">
												</TD>
											</TR>
											<TR>
												<TH>
												...
												<TD align="left">
													<INPUT name="bphone" id="bphone" value="${business.bphone }">
												</TD>
											</TR>
											<TR>
												<TH>
												...
												<TD align="left">
													<INPUT name=bcontact id="bcontact"
														value="${business.bcontact }">
											...
											<TR>
												...
												<TD align="left">
													<INPUT name=baddress id="baddress" value="${business.baddress }"
														size="30">
												</TD>
											</TR>
												...
												<TD align="left">
													<textarea name=bprofile id="bprofile" value="${business.bprofile }"
											...
											<TR>
												...
												<td align="left">
													<c:if test="${business.blicenseimage!='' }">
														<IMG alt="" src="uploadIMG/${business.blicenseimage }" width=120
															height=120>
														<br>
													</c:if>
													<INPUT id="file" type="file" name=image
														value="${business.blicenseimage }">
											...
											<TR>
												...
												<TD align="left">
													<textarea rows="5" cols="50" name="remark" id="remark">${business.remark}</textarea>
												</TD>
											</TR>
											<TR>
												<TH></TH>
