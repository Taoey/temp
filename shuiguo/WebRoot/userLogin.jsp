...
<SCRIPT language=JavaScript>
	function checklogin() {
		...
		var index = utype.selectedIndex; // 选中索引

        var text = utype.options[index].text; // 选中文本
		if(text=="普通用户"){
		  var form1=document.getElementById("form1");
		  form1.action="users.do?method=usersLogin";
		  form1.submit();
		  return true;
		}else if(text=="商家用户"){
		  var form1=document.getElementById("form1");
		  form1.action="business.do?method=businessLogin";
		  form1.submit();
		  return true;
		}else{
		    alert("请选择用户类型");
...
<BODY onload="javascript:document.getElementById('uname').focus()">
	<DIV align=center>
							...
							<TBODY>
								<TR>
									...
									<TD align=right height=30><IMG height=12
										...
										href="index.jsp" target=""><FONT color=#00ae57>首页</FONT> </A>
									</TD>
								</TR>
								<TR>
		...
		<FORM id="form1" name=form1 onSubmit="return checklogin();"
			method=post>
					...
					<TR>
						<TD vAlign=top>
											...
											<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
												<TBODY>
													...
													<TR>
														...
														<TD align=middle bgColor=#f4f4f4><FONT color=#ff0000>用户登录</FONT>
														</TD>
							...
							<TABLE style="BORDER-LEFT: #bcbcbc 1px solid" cellSpacing=0
								...
								<TBODY>
									<TR>
										<TD width=157 background=images/img_title2.gif height=58>&nbsp;</TD>
										<TD align=right width=333 background=images/img_title2.gif></TD>
										<TD style="BORDER-RIGHT: #bcbcbc 1px solid" align=right
											width=210 background=images/img_title2.gif>&nbsp;</TD>
									</TR>
									<TR>
										<TD colSpan=3>
											<TABLE
														...
														<TD><BR>
															...
															<TABLE cellSpacing=0 cellPadding=4 width=500 align=center
																...
																<TBODY>
																	...
																	<TR>
																		<TD align=right width="40%"><FONT color=#333333>用户名：</FONT>
																		</TD>
																		<TD align=left><INPUT class=txtinput1 tabIndex=1
																			size=16 id="uname" name="uname">&nbsp;&nbsp;<A
																			href="regUsers.jsp">立即注册</A>
																		</TD>
																	</TR>
																	<TR>
																	...
																	<TR>
																		<TD align=right><FONT color=#333333>密 码：</FONT>
																		</TD>
																	...
																	<TR>
																		<TD align=right><FONT color=#333333>用户类型：</FONT>
																		</TD>
																		<TD align=left><select id="userType">
																				<option value="typeusers">普通用户</option>
																				<option value="typebusiness">商家用户</option>
