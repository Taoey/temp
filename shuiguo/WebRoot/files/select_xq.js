...
function checked(){
  if($('#combox').val()){
		...
		if($('[name="miaomu_id"]')[0])$('[name="miaomu_id"]')[0].value = $('#combox').val();
		if($('[name="xqy"]')[0])$('[name="xqy"]')[0].value = $('#combox option:selected').attr('xqy');
		if($('[name="address"]')[0])$('[name="address"]')[0].value = $('#combox option:selected').attr('address');
		if($('[name="wylx"]')[0])$('[name="wylx"]')[0].value = $('#combox option:selected').attr('miaomu_lx');
		if($('[name="miaomu_name"]')[0])$('[name="miaomu_name"]')[0].value = $('#combox option:selected').text();
  }
}